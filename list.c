...
/* Creates a list node and inserts it after the specified nodenew_node
...
/* loop an element in the list by using the loop handle function
 * Arguments: A pointer to a list, the loop handle function and a pointer to the
 * data
 */
